...
| ----------- | ---------------- |
| * Muy eficientes en términos de espacio * facilidad de navegación | * Implementación estática (puede ser necesario duplicar el arreglo (o achicarlo) a medida que se agregan/eliminan elementos.| 
