...
| :-----------: | :----------------: |
| <p>Muy eficientes en términos de espacio</p> <p> facilidad de navegación</p> | Implementación estática (puede ser necesario duplicar el arreglo (o achicarlo) a medida que se agregan/eliminan elementos.| 
